...
//_____________________________________________________________________________
VerticalInterpPdf::VerticalInterpPdf(const char *name, const char *title, const RooArgSet &x, const RooArgList& inFuncList, const RooArgList& inCoefList, Double_t quadraticRegion, Int_t quadraticAlgo) :
	RooAbsPdf(name,title),
	_x("x","Independent variable",this),
	_normIntMgr(this,10),
...
//	std::cout<< "nominal "<<funcInt->getVal()<<"\t"<< overall<< "\t"<<funcInt2d->getVal()<<std::endl;
	//Double_t central = overall; 
...
//		std::cout<< "nominal up "<<funcIntUp->getVal()<<"\t nominal dn"<<funcIntDn->getVal()<<std::endl; 
//		std::cout<< "up dn "<<interpolate(coefVal, central, funcIntUp, funcIntDn)<<"\t"<< overall<< "\t"<<funcInt2d->getVal()<<std::endl;
...
{
//	std::cout<< _quadraticAlgo<<"\t"<< coeff<<std::endl;
	if (_quadraticAlgo == -1) {
