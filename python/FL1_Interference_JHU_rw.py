...
class FL1_Interference_JHU_rw(PhysicsModel):
...
#        self.modelBuilder.factory_('expr::muVc("@1/(1+{sigma1_HZZ}/{sigmaL1_HZZ}*{sigmaL1_VBF}/{sigma1_VBF}*abs(@0))", CMS_zz4l_fai1,muV)'.format(**xsecs))
...
FL1_Interference_JHU_rw = FL1_Interference_JHU_rw()
